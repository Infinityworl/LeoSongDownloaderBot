...
async def cb_data(Client, msg:CallbackQuery):
    if msg.data == "home":
        ...
        await msg.message.reply_photo("https://telegra.ph/file/7af5e5f9537e4bbe3461a.jpg",
            caption="",
        ...
        await msg.message.reply_photo("https://telegra.ph/file/3a3d6c2bc0262d656fbf2.jpg",
            caption="",
            reply_markup=Translation.ABOUT_BUTTONS 
        )
    elif msg.data == "about_bot":
        await msg.message.reply_photo("https://telegra.ph/file/0a74f0d99895100076640.jpg",
            caption=Translation.ABOUT_TEXT,
            reply_markup=Translation.ABOUT_BOT_BUTTONS
        )
    elif msg.data == "aboutdev":
        await msg.message.reply_photo("https://telegra.ph/file/bafeaf3fb8119b136b781.jpg",
            caption="",
        ...
        await msg.message.reply_photo("https://telegra.ph/file/4a3960b085743a6f1bf32.jpg",
            caption=Translation.INFO_TEXT.format(username=msg.from_user.username, first_name=msg.from_user.first_name, last_name=msg.from_user.last_name, user_id=msg.from_user.id, mention=msg.from_user.mention),
